    ...
    <header className="bg-surface-dark py-section" role="banner">
      <div className="mx-auto grid max-w-finsight gap-xxl px-lg lg:grid-cols-[minmax(0,0.95fr)_minmax(420px,1fr)] lg:items-center">
        ...
        <div className="relative min-h-[420px]">
          <article className="absolute right-0 top-0 w-[min(100%,420px)] rounded-card border border-hairline bg-surface-dark-elevated p-xl">
            ...
            <div className="mt-xl">
              <p className="num text-on-dark">{preview.amount}</p>
            ...
            <div className="mt-xl space-y-sm">
              {preview.rows.map((row) => (
                <div
                  className="flex items-center justify-between gap-base rounded-field border border-hairline bg-surface-dark px-base py-sm"
                  key={row.label}
                >
          ...
          <aside className="absolute bottom-0 left-0 w-[min(82%,320px)] rotate-2 rounded-card border border-hairline bg-surface-dark-elevated p-lg">
